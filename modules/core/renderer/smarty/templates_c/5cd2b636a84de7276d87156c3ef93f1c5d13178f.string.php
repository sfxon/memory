<?php /* Smarty version Smarty-3.1.11, created on 2016-08-04 11:10:28
         compiled from "5cd2b636a84de7276d87156c3ef93f1c5d13178f" */ ?>
<?php /*%%SmartyHeaderCode:209723747257a30684a33fa2-55749740%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5cd2b636a84de7276d87156c3ef93f1c5d13178f' => 
    array (
      0 => '5cd2b636a84de7276d87156c3ef93f1c5d13178f',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '209723747257a30684a33fa2-55749740',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57a30684b8b7b8_03115770',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57a30684b8b7b8_03115770')) {function content_57a30684b8b7b8_03115770($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/webspace/16/104471/mind-the-memory.com/modules/core/renderer/smarty/plugins/function.cycle.php';
...
.jpg<?php }?>" data-attr-animation="<?php echo $_smarty_tpl->tpl_vars['card']->value['card_data']['animations'][1]['filename_with_path'];?>
...
.jpg<?php }?>" class="img-responsive" data-attr-test="<?php echo $_smarty_tpl->tpl_vars['CARD_COLORS']->value[$_smarty_tpl->getVariable('smarty')->value['foreach']['card_loop']['index']];?>
.jpg" />
...
" data-attr-image="<?php if ($_smarty_tpl->tpl_vars['SECOND_CHANCE']->value==1){?>data/templates/blitz2016/images/bg_wall.png<?php }else{ ?>data/images/cardcovers/<?php echo $_smarty_tpl->tpl_vars['CARD_COLORS']->value[$_smarty_tpl->getVariable('smarty')->value['foreach']['card_loop']['index']];?>
.jpg<?php }?>" data-attr-image-show="<?php echo $_smarty_tpl->tpl_vars['card']->value['card_data']['images'][3]['filename_with_path'];?>
">
												<div class="card_border_container">
...
.jpg<?php }else{ ?>style="border-color: #292929;"<?php }?>">
																<img src="<?php if ($_smarty_tpl->tpl_vars['SECOND_CHANCE']->value==1){?>data/templates/blitz2016/images/bg_wall.png<?php }else{ ?>data/images/cardcovers/<?php echo $_smarty_tpl->tpl_vars['CARD_COLORS']->value[$_smarty_tpl->getVariable('smarty')->value['foreach']['card_loop']['index']];?>
.jpg<?php }?>" class="img-responsive" />
